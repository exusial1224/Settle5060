...
<p>営業時間：<label>開始時間<input type="time" name="open_time" value="${fac_info.open_time}"></label>～<label>終了時間<input type="time" name="close_time" value="${fac_info.close_time}"></label></p>
<p>販売開始日：<label>販売開始日<input type="number" name="sls_str" value="${fac_info.sls_str}"></label>日前</p>
<p>各タイムスロットの上限人数：<label>上限人数<input type="number" name="max_num" value="${fac_info.max_num}"></label></p>
...
<p>価格範囲：<label>最低価格<input type="number" name="low_price" value="${fac_info.low_price}"></label>～<label>最高価格<input type="number" name="high_price" value="${fac_info.high_price}"></label></p>
<p>初期価格：<label>最低価格<input type="number" name="init_price" value="${fac_info.init_price}"></label></p>
<p>当日券価格：<label>当日券価格<input type="number" name="sd_tkt_price" value="${fac_info.sd_tkt_price}"></label></p>
<p>子供割引：<label>割引率<input type="number" name="chld_dsc" value="${fac_info.chld_dsc}"></label>%引き</p>
