...
%>
        ...
        <table border="1">
		    ...
		    %>
		        <tr>
		        	<td>
				        <form action="ResaleRegister" method="post" style="display: inline;">
				            <input type="hidden" name="selectedSlotId" value="<%= slot.getSl_id() %>">
				            <button type="submit" <%= slot.getRemain() == 0 ? "disabled" : "" %>>リセール登録</button>
				        </form>
			    	</td>
