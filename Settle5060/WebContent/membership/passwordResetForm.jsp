...
<body>
    ...
    　　<form action="PasswordChange" method="post">
	        <div class="login-input" >
	            ...
	            <div class="login-input">
	            <label for="password" class="text-form">パスワード確認</label>
	            <input name="newPassword" type="password" id="confirmPassword" placeholder="🔒Password" class="input-form" pattern="[!-~]{8,}" title="8文字以上で入力してください。" required>
