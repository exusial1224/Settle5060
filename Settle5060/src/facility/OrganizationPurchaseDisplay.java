...
@WebServlet("/facility/OrganizationPurchaseDisplay")
public class OrganizationPurchaseDisplay extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            response.sendRedirect("organizationPurchaseInfo.jsp");
        } catch (Exception e) {
            e.printStackTrace();
